...
#include "IApplet.h"
#include "services/applet/applet_creator.h"
...
namespace skyline::service::am {
    ...
    class ILibraryAppletAccessor : public BaseService {
      private:
        ...
        std::shared_ptr<kernel::type::KEvent> popNormalOutDataEvent; //!< This KEvent is triggered when there's normal data for the guest to pop
        std::shared_ptr<kernel::type::KEvent> popInteractiveOutDataEvent; //!< This KEvent is triggered when there's interactive data for the guest to pop
      ...
      public:
        ILibraryAppletAccessor(const DeviceState &state, ServiceManager &manager, applet::AppletId appletId, applet::LibraryAppletMode appletMode);
