...
namespace skyline::service::am {
    ...
    class ILibraryAppletCreator : public BaseService {
      public:
        ...
        /**
         * @brief Creates an IStorage that can be used by the application, backed by a vector<u8>
        ...
        /**
         * @brief Creates an IStorage that can be used by the application, backed by a transfer memory
