...
namespace skyline::service::applet {
    ...
    std::shared_ptr<am::IApplet> CreateApplet(const DeviceState &state, service::ServiceManager &manager, service::applet::AppletId appletId, const std::shared_ptr<kernel::type::KEvent> &onAppletStateChanged, const std::shared_ptr<kernel::type::KEvent> &onNormalDataPushFromApplet, const std::shared_ptr<kernel::type::KEvent> &onInteractiveDataPushFromApplet, applet::LibraryAppletMode appletMode);
}